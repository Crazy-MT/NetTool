...
public class ConnectionClassManager {
    ...
    /*package*/ static final double DEFAULT_SAMPLES_TO_QUALITY_CHANGE = 1;
    ...
    private void notifyListeners() {
        ...
        for (int i = 0; i < size; i++) {
            mListenerList.get(i).onBandwidthStateChange(mCurrentBandwidthConnectionQuality.get(), mDownloadBandwidth.getAverage());
        }
    }
}